...
class WBManager:
    ...
    async def round(self):
        ...
        # Create the round
        if gm_msg.content.startswith('!wb -round create'):
            athing = ""

        return

    async def get_current_round(self, game: Game, guild: Guild, dbmgr: DBManager) -> Round:
        return
    ...
    async def check_player_registered(self, dbmgr: DBManager, guild: Guild, user: User, channel: TextChannel) -> Player:
